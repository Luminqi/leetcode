...
The api can be changed to actions in, actions out like redux-observable, but I think this api is more
straightforward.

The most important thing is still to guarantee the action$ emits value after the state updated.
*/
